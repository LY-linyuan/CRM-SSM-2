	...
	<div style="position: relative; top: 40px; left: 40px;">
		...
		<c:forEach items="${clueRemarkList}" var="remark">
			<div class="remarkDiv" style="height: 60px;">
				...
				<div id="div_${remark.id}" style="position: relative; top: -40px; left: 40px;" >
					<h5>${remark.noteContent}</h5>
					<font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullname}${clue.appellation}-${clue.company}</b>
					<small style="color: gray;"> ${remark.editFlag == '1' ? remark.editTime : remark.createTimr} 由${remark.editFlag == '1' ? remark.editBy : remark.createBy}${remark.editFlag == '1' ? '修改' : '创建'}</small>
